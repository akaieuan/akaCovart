...
// object carries mood + composition/finish/texture values exactly as the
...
export const presets: Preset[] = [
  {
    ...
    params: {
      ...
      grain: 54, grainSize: 46, dust: 14, scratches: true, scratchCount: 4,
    },
  },
  {
    name: "RITUAL",
    params: {
      ...
      grain: 58, grainSize: 50, dust: 18, scratches: true, scratchCount: 6,
    },
  },
  {
    name: "ASH",
    params: {
      ...
      grain: 72, grainSize: 58, dust: 28, scratches: true, scratchCount: 9,
    },
  },
  {
    name: "BLEACH",
    params: {
      ...
      grain: 52, grainSize: 48, dust: 12, scratches: true, scratchCount: 5,
    },
  },
  {
    name: "TOXIC",
    params: {
      ...
      grain: 50, grainSize: 44, dust: 16, scratches: true, scratchCount: 6,
    },
  },
  {
    name: "STATIC",
    params: {
      ...
      grain: 94, grainSize: 64, dust: 42, scratches: true, scratchCount: 13,
    },
  },
  {
    name: "OBSIDIAN",
    params: {
      ...
      grain: 46, grainSize: 52, dust: 10, scratches: false, scratchCount: 3,
    },
  },
  {
    name: "HAZE",
    params: {
      ...
      grain: 54, grainSize: 50, dust: 14, scratches: true, scratchCount: 6,
    },
  },
];
